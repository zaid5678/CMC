...
import type { SiteSettings } from '@/lib/contentful';
...
export default function ContactClient({ settings }: { settings: SiteSettings }) {
  ...
  const fullAddress = `${settings.addressLine1}, ${settings.addressLine2}, ${settings.addressLine3}`;
            ...
            <SectionReveal>
              ...
              <div className="space-y-2 mb-8">
                <p className="text-sm" style={{ fontFamily: 'var(--font-body)', color: 'var(--color-ink-soft)' }}>
                  ...
                  <a href={`mailto:${settings.email}`} style={{ color: 'var(--color-green-mid)' }}>
                    {settings.email}
                  </a>
                </p>
                <p className="text-sm" style={{ fontFamily: 'var(--font-body)', color: 'var(--color-ink-soft)' }}>
                  <strong style={{ color: 'var(--color-ink)' }}>Phone: </strong>
                  <a href={`tel:${settings.phone.replace(/\s/g, '')}`} style={{ color: 'var(--color-green-mid)' }}>
                    {settings.phone}
                  </a>
                </p>
                <a
